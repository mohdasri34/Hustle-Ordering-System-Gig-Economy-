...
if(isset($_POST['submit'])){
   ...
   $update_profile_name = $conn->prepare("UPDATE `employee` SET name = ? WHERE id = ?");
   $update_profile_name->execute([$name, $employee_id]);
   ...
   if($old_pass == $empty_pass){
      ...
      if($new_pass != $empty_pass){
         $update_employee_pass = $conn->prepare("UPDATE `employee` SET password = ? WHERE id = ?");
         $update_employee_pass->execute([$confirm_pass, $employee_id]);
